--0. Adicionei alguns scripts para ajudar no momento de validar as soluções.
...
--1. Modifiquei o tipo de cpf para um tipo textual,
...
--7. Criaria uma tabela stg_prontuario.atendimento_medico e uma tabela stg_prontuario.diagnostico
